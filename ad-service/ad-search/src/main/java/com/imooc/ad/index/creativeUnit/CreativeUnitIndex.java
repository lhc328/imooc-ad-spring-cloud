 ...
 * @Author: HongchaoLv
 * @Description:
 * @Date: Created in 10:45 2020/5/23
 * @Modified By:
 */
@Slf4j
@Component
public class CreativeUnitIndex implements IndexAware<String, CreativeUnitObject> {
    ...
    public void add(String key, CreativeUnitObject value) {
        log.info("creativeUnit before add: {}", map);
        map.put(key, value);
        ...
        log.info("creativeUnit after add: {}", map);
    }
    ...
    public void delete(String key, CreativeUnitObject value) {
        log.info("creativeUnit before delete: {}", map);
        map.remove(key);
        Set<Long> unitSet = creativeUnitMap.get(value.getAdId());
        ...
        log.info("creativeUnit after delete: {}", map);
    }
